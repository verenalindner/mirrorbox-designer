var HalfCircle = Class.create({
    ...
    toModel: function(info) {
        this.radius = info.shape.halfCircle.radius;
        ...
        this.createjsShape.regY = -this.radius/2;

        this.mask.graphics.beginFill(this.color).drawRect(0,0, this.radius*2+2, this.radius+2);
        this.mask.x = this.createjsShape.x;
        this.mask.y = this.createjsShape.y;
        this.mask.regX = this.radius;
        this.mask.regY = this.radius/2;
        this.createjsShape.mask = this.mask;
    ...
    redrawGraphic: function() {
        ...
        this.createjsShape.setBounds(0, 0, this.radius * 2, this.radius);
